...
function Footer() {
  ...
  return (
    <Box sx={{ bgcolor: "#000000", pt: 10, pb: 3, color: "#FFFFFF" }}>
      <Container maxWidth="auto" className="mt-32 px-6 lg:px-16 max-w-[1400px] mx-auto">
        <Grid container spacing={10}>
          ...
          {footerData.map((section, index) => (
            <Grid item xs={6} md={2} key={index} spacing={10}>
              <Typography
                sx={{
                  fontWeight: "500",
                  mb: 2,
              ...
              {section.links.map((link, linkIndex) => (
                <Box key={linkIndex} display="block" sx={{ my: 1 }}>
                  <Link
                    href="#"
                    color="#737373"
                    underline="none"
        ...
        <hr 
          style={{ color: "#C4C4C4", marginTop: "40px", marginBottom: "10px" }}
        />
